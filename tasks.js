...
};
{
    ...
    function filterByRating(items) {
        return items.filter(function (book) { return book.rating >= 4; });
    }
    ...
    var Vehicle = /** @class */ (function () {
        function Vehicle(_make, _year) {
            this._make = _make;
            this._year = _year;
        }
        Vehicle.prototype.getInfo = function () {
            console.log("Make: ".concat(this._make, ", Year: ").concat(this._year));
        };
        return Vehicle;
    }());
    var Car = /** @class */ (function (_super) {
        __extends(Car, _super);
        function Car(_make, _year, _model) {
            var _this = _super.call(this, _make, _year) || this;
            _this._model = _model;
            return _this;
        }
